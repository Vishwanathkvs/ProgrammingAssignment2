...
## The following function calculates the inverse of a matrix and daves it to the cache such that
## the next time user attempts to calculate the matrix inverse, the previpously saved value is retuirned instead of
##  repeating the calculation
## by Viswanath Koppaka
## date:-12/14/2016
## 
